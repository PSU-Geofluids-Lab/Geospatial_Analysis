...
# class Gaussian_Field_Generator(BaseGenerator):
#     def __init__(self, name='test1',size=256):
#         self.name = "Gaussian_Field_Generator/"+name
#         self.size = size
#         self.data = None
#         self.metadata = {
#             'generator_type': self.name,  # Use the provided name here
...
#     def generate(self, grid_size=100, spatial_corr=0.7):
#         """
...
#         Returns:
#         Pandas Dataset: Spatial grid with soil and basalt properties
#         """
...
#         kernel = RBF(length_scale=spatial_corr)
